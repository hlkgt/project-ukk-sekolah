                    ...
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0 is-revealing">
                                Wellcome to Wesite SMKN 1 DLANGGU
                            </h1>
                            <p class="hero-paragraph is-revealing">
                                SMKN 1 Dlanggu adalah Sekolah Menengah Kejuruan Negeri yang berbasis Teknologi dan
                                Pariwisata untuk mencetak lulusan yang siap menjadi professional muda di bidang
                                teknologi dan pariwisata, berjiwa religius, cinta tanah air serta berwirausaha. Dengan
                                dukungan sumber daya manusia pengajar yang berkuwalitas dan sarana prasarana yang
                                lengkap demi menjawab kebutuhan dunia usaha dan industri Indonesia
                            </p>
                            <div class="hero-form field field-grouped is-revealing">
                                <div class="control">
                                    <a class="button button-primary button-block" href="{{route('login')}}">Learn More</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="feature">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">
                                        Menghasilkan tamatan yang profesional,kompetitif secara nasional dan
                                        internasional, beriman dn bertaqwa serta cinta tanah air dan mampu berwirausaha
                                    </p>
                                </div>
                            </div>
                            <div class="feature">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">
                                        1.Melaksanakan kurikulum berstandar kompetensi untuk menyiapkan tamatan yang
                                        siap pakai di dunia kerja.<br><br>
                                        2.Meningkatkan professional dan akuntabilitas SMKN 1 Dlanggu sebagai pusat
                                        pendidikan yang berstandar nasional.<br><br>
                                        3.Meningkatkan profesionalisme tenaga pendidik yang mempunyai kompetensi sesuai
                                        dengan bidang keahlian.<br><br>
                                        4.Meningkatkan kualitas tamatan yang menguasai teknologi yang dilansadi iman dan
                                        taqwa.
                                    </p>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    <div class="footer-copyright">
                        &copy; website SMK Negeri 1 Dlanggu
                    </div>
